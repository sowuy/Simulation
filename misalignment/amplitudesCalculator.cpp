...
int main(int argc, char** argv){
	...
	double w = -1;
        double init = -1*pow(10,-3);
        double width = abs(2*init);
	const double delta1 = getRandomInRange(generator,init,width);
	const double delta2 = getRandomInRange(generator,init,width);

	const double delta3 =  getRandomInRange(generator,init,width);


	const double delta4 = getRandomInRange(generator,init,width);
